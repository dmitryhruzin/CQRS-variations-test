...
const classificator = new Classificator(33, 41.5)
...
console.table({
  canonicalToClassicalCQRS: classificator.calculateMigrationComplexity(
    migration.canonicalToClassicalCQRSDesignComplexity,
    migration.canonicalToClassicalCQRSImplementationComplexity
  ),
  canonicalToMCQRS: classificator.calculateMigrationComplexity(
    migration.canonicalToMCQRSDesignComplexity,
    migration.canonicalToMCQRSImplementationComplexity
  ),
  classicalToMCQRS: classificator.calculateMigrationComplexity(
    migration.classicalToMCQRSDesignComplexity,
    migration.classicalToMCQRSImplementationComplexity
  ),
  mCQRSToClassical: classificator.calculateMigrationComplexity(
    migration.mCQRSToClassicalCQRSDesignComplexity,
    migration.mCQRSToClassicalCQRSImplementationComplexity
  ),
  mCQRSToMCQRSCoE: classificator.calculateMigrationComplexity(
    migration.mCQRSToMCQRSCoEDesignComplexity,
    migration.mCQRSToMCQRSCoEImplementationComplexity
  )
})

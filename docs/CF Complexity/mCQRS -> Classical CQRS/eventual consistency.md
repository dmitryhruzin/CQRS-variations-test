...
| ID    | Name                                                  | Type          | Weight |
|-------|-------------------------------------------------------|---------------|--------|
| BCS1  | Get Projection Snapshot from the SnapshotDB           | function call | 2      |
| BCS2  | Get Events from the Event Store                       | function call | 2      |
| BCS3  | Create new Projection instance based on Snapshot Data | sequence      | 1      |
| BCS4  | For each event in Events                              | iteration     | 3      |
| BCS5  | Determine event type                                  | branch        | 2      |
| BCS6  | Replay event onto Projection                          | sequence      | 1      |
| BCS7  | Get Snapshot from the SnapshotDB                      | remove        | 1      |
| BCS8  | Map Snapshot to Projection                            | remove        | 1      |
| Total |                                                       |               | 13     |

**Migration Complexity:** 1 × 13 = **13**  
